...
class AnyOpenAILLM(BaseLLM):
    def __init__(self, model_name: str = 'gpt-3.5-turbo-1106', json_mode: bool = False, *args, **kwargs):
    ...
    def __call__(self, prompt: str, *args, **kwargs) -> str:
        ...
        # client = InferenceClient(api_key="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")
